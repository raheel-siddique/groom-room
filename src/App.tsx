...
const App=()=>{
  ...
  return(
    <>
    <Layout style={{paddingInline:'none',padding:0, margin:'none', backgroundColor:'#FFFFFF'}}>
...
style={{ overflow: 'auto', height: '100vh', position: 'sticky', top: 0, left: 0,background:'#FFFFFF' }}
  width={300}  className='siderbar_main'>
          <Sidebar />
        </Sider>
